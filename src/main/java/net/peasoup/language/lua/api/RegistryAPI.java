...
public class RegistryAPI {
    ...
    // 1.21.1: ArmorItem now uses EquipmentSlot instead of EquipmentType
    private static @NotNull Item getArmorItem(String type, RegistryEntry<ArmorMaterial> material, Item.Settings settings) {
        EquipmentSlot slot = switch (type.toLowerCase()) {
    ...
    // Tool materials - 1.21.1 uses registry entries
    ...
    // Armor materials - 1.21.1 returns RegistryEntry<ArmorMaterial>
    private RegistryEntry<ArmorMaterial> getArmorMaterial(String name) {
        return switch (name.toLowerCase()) {
            case "leather" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("leather")).orElse(null);
            case "chain", "chainmail" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("chainmail")).orElse(null);
            case "iron" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("iron")).orElse(null);
            case "gold", "golden" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("gold")).orElse(null);
            case "diamond" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("diamond")).orElse(null);
            case "turtle" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("turtle")).orElse(null);
            case "netherite" -> Registries.ARMOR_MATERIAL.getEntry(Identifier.ofVanilla("netherite")).orElse(null);
            default -> null;
        };
    }
    ...
    /**
     * Register a tool with proper attack values (1.21.1 style)
     */
    private Item registerTool(String name, LuaValue settingsTable) {
        ...
        // 1.21.1: Tool constructors only take (ToolMaterial, Settings)
    ...
    /**
     * Register armor pieces (1.21.1 style)
     */
    private Item registerArmor(String name, LuaValue settingsTable) {
        ...
        RegistryEntry<ArmorMaterial> material = getArmorMaterial(materialName);
        if (material == null) {
        ...
        Item item = getArmorItem(type, material, settings);
        Registry.register(Registries.ITEM, itemKey, item);
