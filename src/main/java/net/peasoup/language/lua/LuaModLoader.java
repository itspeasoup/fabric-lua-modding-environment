...
public class LuaModLoader {
    ...
    private void loadMod(String modId) {
        ...
        try {
            Path modPath = Paths.get("mods").resolve(modId);
            ...
            LuaModContainer container = new LuaModContainer(metadata, modPath);
            ...
            if (success) {
                ...
                LOGGER.info("Loaded mod: {} v{}", metadata.name, metadata.version);
            } else {
            ...
            paths.filter(Files::isDirectory).forEach(path -> {
                ...
                try {
                    ...
                    if (metadata.hasDatagen()) {
                        ...
                        LuaModContainer container = new LuaModContainer(metadata, path);
    ...
    public boolean reloadMod(String modId) {
        ...
        try {
            ...
            LuaModContainer newContainer = new LuaModContainer(metadata, modPath);
